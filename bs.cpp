...
////double FBlsPrice(double CoP, double S, double X, double R, double Q, double Trate, double Tsigma, double sig);
////
////
...
//}
////
////inline double BlsD1(double F, double X, double Tsigma, double sig)
////{
